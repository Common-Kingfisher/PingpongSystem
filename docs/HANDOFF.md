...
- 淘汰赛交叉对阵已冻结：偶数组每组前二采用首尾交叉（4 组即 A1-D2、C1-B2、B1-C2、D1-A2），同组两人与 1/2 号种子分处不同半区。6 组场景已经采用首尾交叉思想；因 12 个晋级名额需要进入 16 签，具体轮空落位目前仍是确定性的兼容实现，尚未作为正式比赛规则冻结，需以后根据真实赛事规程确认。奇数组继续明确为未冻结。以上均为本项目自有规则，不宣称等同于官方/国际赛制。
